    ...
    Partial Public Class PublishersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Publishers` SET `PubID` = ?, `Name` = ?, `Company Name` = ?, `Address` = "& _ 
                "?, `City` = ?, `State` = ?, `Zip` = ?, `Telephone` = ?, `Fax` = ? WHERE ((`PubID"& _ 
                "` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Company"& _ 
                " Name` IS NULL) OR (`Company Name` = ?)) AND ((? = 1 AND `Address` IS NULL) OR ("& _ 
                "`Address` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND"& _ 
                " `State` IS NULL) OR (`State` = ?)) AND ((? = 1 AND `Zip` IS NULL) OR (`Zip` = ?"& _ 
                ")) AND ((? = 1 AND `Telephone` IS NULL) OR (`Telephone` = ?)) AND ((? = 1 AND `F"& _ 
                "ax` IS NULL) OR (`Fax` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Publisher.My.MySettings.Default.ContactsConnectionString
        End Sub
